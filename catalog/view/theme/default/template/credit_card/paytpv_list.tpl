      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><?php echo $card['paytpv_brand']; ?></td>
              <td class="text-left"><?php echo $card['paytpv_cc']; ?></td>
              
			        <td class="text-right"><a href="<?php echo $delete . $card['paytpv_iduser']; ?>" class="btn btn-danger"><?php echo $button_delete; ?></a></td>
