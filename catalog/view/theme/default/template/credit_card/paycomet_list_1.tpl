      ...
      <div class="content">
        <table width="100%" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td width="20%" class="text-left"><?php echo $card['paycomet_brand']; ?></td>
              <td width="20%" class="text-left"><?php echo $card['paycomet_cc']; ?></td>
              
			        <td width="60%" class="text-right"><a href="<?php echo $delete . $card['paycomet_iduser']; ?>" class="btn btn-danger"><?php echo $button_delete; ?></a></td>
